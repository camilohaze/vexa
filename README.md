...
apps/
  ...
  web-company        Angular 22 + Material — portal de empresas
  web-admin          Angular 22 + Material — panel de administración
  mobile-courier     Flutter — app del repartidor (GPS, tracking, FCM)
libs/
...
cd apps/mobile-courier; flutter run
```
